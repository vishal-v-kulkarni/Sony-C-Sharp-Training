...
public class MainClass{
	...
	public void evaluateMarkPer(MarketingTeam mt,MarketingTeam mt1){
		...
		Console.WriteLine("The employee {0} of Marketing Team is {1}" ,mt.Name,mt.evaluateGrade(mPercent));
	...
	public void evaluateTechPer(TechnicalTeam tt,TechnicalTeam tt1){
		...
		Console.WriteLine("The employee {0} of Technical Team is {1}" ,tt.Name,tt.evaluateGrade(mPercent));
