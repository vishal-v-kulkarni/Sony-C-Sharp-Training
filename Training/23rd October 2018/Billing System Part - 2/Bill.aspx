<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bill.aspx.cs" Inherits="BillingSystem_Web.Bill" %>
...
<body style="width: 970px; height: 45px;">
    ...
    <table>
         <tr>
            <td class="auto-style10">Customer Name : Vishal</td>
            <td class="auto-style16">Bill No : 2</td>
             <td class="auto-style17">Date : 10th October 2018</td>
             <td class="auto-style12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Time : 17:35 hrs</td>
        </tr>
    </table>
        <br/><br/>
